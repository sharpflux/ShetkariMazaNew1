...
public class GovtDepartmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_govt_department);

        recyclerView = findViewById(R.id.contact_Detail_rvProductList2);
        customDialogLoadingProgressBar = new CustomDialogLoadingProgressBar(GovtDepartmentActivity.this);
        contactlist = new ArrayList<>();
        recyclerView.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        mList = new ArrayList<>();
        myDatabase = new dbFilter(GovtDepartmentActivity.this);
...
//        txt_emptyView.setVisibility(View.GONE);
      ...
      //  initScrollListener();
        ...
        tv_filter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GovtDepartmentActivity.this, Filter1Activity.class);
    ...
    private void initAdapter() {
        myAdapter = new GovtDeptAdapter(GovtDepartmentActivity.this, mList);
    ...
    class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(GovtDepartmentActivity.this,
                    "Loading...",
                    "");
        }
