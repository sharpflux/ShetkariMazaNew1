...
public class MyAdapter extends BaseAdapter {
    ...
    public MyAdapter(Context context, ArrayList<Uri> arrayList, ArrayList<String> ImagesListobj) {
        this.context = context;
        this.arrayList = arrayList;
        this.ImagesList=ImagesListobj;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mInflater != null) {
            convertView = mInflater.inflate(R.layout.list_items_images, null);
        }
